...
3 TRT engines (image_encoder, mask_decoder, memory_encoder)
+ ONNX Runtime CUDA EP for memory_attention (TRT 10.3 Myelin bug workaround).
...
def main():
    ...
    trt_stream.synchronize()  # sync before ORT dec
    ...
    matt({"current_vision_feat": vf,
          "current_vision_pos_embed": vp,
    ...
    while True:
        ...
        if frame_idx == 0:
            ...
            # Sync TRT stream before ORT mask_decoder call
            trt_stream.synchronize()
